...
const serviceAccount = require('./fsw32-platinum-team1-firebase-adminsdk-sbc3l-15d12d3f22.json')
...
// upload files
async function uploadFile (path, filename, filetype) {
...
module.exports = { uploadFile, downloadFile, defaultAvatar, admin }
